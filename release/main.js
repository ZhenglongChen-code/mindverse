...
// ../core/dist/configLoader.js
var require_configLoader = __commonJS({
  "../core/dist/configLoader.js"(exports2) {
    "use strict";
...
// ../core/dist/indexManager.js
var require_indexManager = __commonJS({
  "../core/dist/indexManager.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? (function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var IndexManager = class {
      ...
      addProcessedFile(file) {
        ...
        index.lastScanTime = (/* @__PURE__ */ new Date()).toISOString().replace("T", " ").substring(0, 19);
...
// ../core/dist/fileScanner.js
var require_fileScanner = __commonJS({
  "../core/dist/fileScanner.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? (function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.FileScanner = void 0;
    var fs = __importStar(require("fs"));
    var path = __importStar(require("path"));
    var FileScanner = class {
      constructor(basePath, inboxPath) {
       ...
       */
      scanUnprocessed(processedPaths) {
       ...
       * 获取所有已处理文件的路径集合
       */
      getProcessedPaths(index) {
        return new Set(index.processedFiles.map((f) => f.filePath));
      }
    };
    exports2.FileScanner = FileScanner;
  }
});
...
// ../core/dist/aiService.js
var require_aiService = __commonJS({
  "../core/dist/aiService.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.AiService = exports2.HunyuanAdapter = exports2.SparkAdapter = exports2.DeepSeekAdapter = exports2.MoonshotAdapter = exports2.ZhipuAdapter = exports2.BaiduAdapter = exports2.AliyunAdapter = exports2.AnthropicAdapter = void 0;
    exports2.createAiAdapter = createAiAdapter;
    ...
    exports2.AliyunAdapter = AliyunAdapter;
    var BaiduAdapter = class {
      ...
      async getAccessToken() {
        ...
        try {
          const response = await axios_1.default.post(`https://aip.baidubce.com/oauth/2.0/token?grant_type=client_credentials&client_id=${this.apiKey}&client_secret=${this.secretKey}`);
      ...
      async chat(request) {
        try {
          ...
          const response = await axios_1.default.post(`https://aip.baidubce.com/rpc/2.0/ai_custom/v1/wenxinworkshop/chat/${this.modelName}?access_token=${token}`, {
            messages: [
    ...
    exports2.BaiduAdapter = BaiduAdapter;
    ...
    exports2.ZhipuAdapter = ZhipuAdapter;
    var MoonshotAdapter = class {
      constructor(config) {
    ...
    exports2.MoonshotAdapter = MoonshotAdapter;
    ...
    exports2.DeepSeekAdapter = DeepSeekAdapter;
    var SparkAdapter = class {
      constructor(config) {
...
GET /v3.5/chat HTTP/1.1`;
    ...
    exports2.SparkAdapter = SparkAdapter;
    var HunyuanAdapter = class {
      constructor(config) {
    ...
    exports2.HunyuanAdapter = HunyuanAdapter;
    ...
    exports2.AiService = AiService;
  }
});

// ../core/dist/wikiGenerator.js
var require_wikiGenerator = __commonJS({
  "../core/dist/wikiGenerator.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? (function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.WikiGenerator = void 0;
    var fs = __importStar(require("fs"));
    var path = __importStar(require("path"));
    var WikiGenerator = class {
      constructor(basePath, wikiSavePath) {
       ...
       */
      generateWikiFile(content, originalFileName, processTime) {
        if (!fs.existsSync(this.wikiPath)) {
          fs.mkdirSync(this.wikiPath, { recursive: true });
        }
        const titleMatch = content.match(/^#\s+(.+)$/m);
        let baseFileName = titleMatch ? titleMatch[1].replace(/[\\/:*?"<>|]/g, "").trim() : path.basename(originalFileName, ".md");
    ...
    exports2.WikiGenerator = WikiGenerator;
  }
});
...
var require_dist = __commonJS({
  "../core/dist/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.MindverseCore = exports2.WikiGenerator = exports2.createAiAdapter = exports2.AiService = exports2.FileScanner = exports2.IndexManager = exports2.ConfigLoader = void 0;
    var configLoader_1 = require_configLoader();
    Object.defineProperty(exports2, "ConfigLoader", { enumerable: true, get: function() {
      return configLoader_1.ConfigLoader;
    } });
    var indexManager_1 = require_indexManager();
    Object.defineProperty(exports2, "IndexManager", { enumerable: true, get: function() {
      return indexManager_1.IndexManager;
    } });
    var fileScanner_1 = require_fileScanner();
    Object.defineProperty(exports2, "FileScanner", { enumerable: true, get: function() {
      return fileScanner_1.FileScanner;
    } });
    var aiService_1 = require_aiService();
    Object.defineProperty(exports2, "AiService", { enumerable: true, get: function() {
      return aiService_1.AiService;
    } });
    Object.defineProperty(exports2, "createAiAdapter", { enumerable: true, get: function() {
      return aiService_1.createAiAdapter;
    } });
    var wikiGenerator_1 = require_wikiGenerator();
    Object.defineProperty(exports2, "WikiGenerator", { enumerable: true, get: function() {
      return wikiGenerator_1.WikiGenerator;
    } });
    var configLoader_2 = require_configLoader();
    var indexManager_2 = require_indexManager();
    var fileScanner_2 = require_fileScanner();
    var aiService_2 = require_aiService();
    var wikiGenerator_2 = require_wikiGenerator();
    var MindverseCore2 = class {
      constructor(basePath) {
        this.configLoader = new configLoader_2.ConfigLoader(basePath);
        this.config = this.configLoader.loadConfig();
        this.indexManager = new indexManager_2.IndexManager(basePath);
        this.fileScanner = new fileScanner_2.FileScanner(basePath, this.config.inboxPath);
        this.initAiAdapter();
        this.wikiGenerator = new wikiGenerator_2.WikiGenerator(basePath, this.config.wikiSavePath);
      }
      initAiAdapter() {
        const modelConfig = this.configLoader.getActiveModelConfig();
        this.aiAdapter = (0, aiService_2.createAiAdapter)(modelConfig);
      }
      /**
       * 执行全量处理流程
       */
      async processAll() {
        ...
        for (const file of unprocessedFiles) {
          try {
            ...
            const processTime = (/* @__PURE__ */ new Date()).toISOString().replace("T", " ").substring(0, 19);
      ...
      switchModel(provider) {
        ...
        if (!config.modelConfigs[provider]) {
          return false;
        }
    ...
    exports2.MindverseCore = MindverseCore2;
  }
});
...
var MindversePlugin = class extends import_obsidian.Plugin {
  constructor() {
    super(...arguments);
    this.core = null;
    this.cronJob = null;
  ...
  initCore() {
    try {
      this.core = new import_core.MindverseCore(this.app.vault.adapter.getBasePath());
  ...
  async processInbox() {
    if (!this.core) {
      new import_obsidian.Notice("Mindverse \u6838\u5FC3\u672A\u521D\u59CB\u5316\uFF0C\u8BF7\u68C0\u67E5\u914D\u7F6E");
      return;
    }
    try {
      ...
      new import_obsidian.Notice(`Mindverse \u5904\u7406\u5931\u8D25: ${error.message}`);
    }
  }
  async loadSettings() {
    const loaded = await this.loadData();
    this.settings = Object.assign({}, DEFAULT_SETTINGS, loaded || {});
    for (const key of Object.keys(DEFAULT_SETTINGS.modelConfigs)) {
...
var MindverseSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian.Setting(containerEl).setName("\u6A21\u578B\u63D0\u4F9B\u5546").setDesc("\u9009\u62E9\u4F7F\u7528\u7684\u5927\u6A21\u578B").addDropdown((dropdown) => {
      Object.keys(MODEL_LABELS).forEach((key) => {
        dropdown.addOption(key, MODEL_LABELS[key]);
      });
      dropdown.setValue(this.plugin.settings.modelProvider).onChange(async (value) => {
    ...
    new import_obsidian.Setting(containerEl).setName(`${MODEL_LABELS[currentProvider]} API Key`).setDesc(currentProvider === "baidu" ? "\u683C\u5F0F: API_KEY|SECRET_KEY" : "\u8F93\u5165 API \u5BC6\u94A5").addText((text) => text.setPlaceholder("").setValue(currentConfig?.apiKey || "").onChange(async (value) => {
      this.plugin.settings.modelConfigs[currentProvider] = { ...currentConfig, apiKey: value };
      await this.plugin.saveSettings();
    }));
    new import_obsidian.Setting(containerEl).setName(`${MODEL_LABELS[currentProvider]} \u6A21\u578B\u540D\u79F0`).setDesc("\u53EF\u81EA\u5B9A\u4E49\u6A21\u578B\u540D\u79F0\uFF0C\u9ED8\u8BA4\u4F7F\u7528\u63A8\u8350\u6A21\u578B").addText((text) => text.setPlaceholder(currentConfig?.modelName || "").setValue(currentConfig?.modelName || "").onChange(async (value) => {
      this.plugin.settings.modelConfigs[currentProvider] = { ...currentConfig, modelName: value };
      await this.plugin.saveSettings();
    }));
    containerEl.createEl("hr");
    new import_obsidian.Setting(containerEl).setName("\u89E6\u53D1\u6A21\u5F0F").setDesc("\u9009\u62E9\u624B\u52A8\u89E6\u53D1\u3001\u5B9A\u65F6\u81EA\u52A8\u6216\u4FDD\u5B58\u89E6\u53D1").addDropdown((dropdown) => {
      Object.keys(TRIGGER_LABELS).forEach((key) => {
        dropdown.addOption(key, TRIGGER_LABELS[key]);
      });
      dropdown.setValue(this.plugin.settings.triggerMode).onChange(async (value) => {
    ...
    if (this.plugin.settings.triggerMode === "auto") {
      new import_obsidian.Setting(containerEl).setName("\u5B9A\u65F6\u89C4\u5219").setDesc("Cron \u8868\u8FBE\u5F0F\uFF0C\u9ED8\u8BA4\u6BCF 6 \u5C0F\u65F6\u5904\u7406\u4E00\u6B21").addText((text) => text.setPlaceholder("0 */6 * * *").setValue(this.plugin.settings.cronTime).onChange(async (value) => {
        this.plugin.settings.cronTime = value;
        await this.plugin.saveSettings();
      }));
    }
    if (this.plugin.settings.triggerMode === "save") {
      new import_obsidian.Setting(containerEl).setName("\u4FDD\u5B58\u89E6\u53D1\u5DF2\u5F00\u542F").setDesc("\u5728 Inbox \u6587\u4EF6\u5939\u4E2D\u4FDD\u5B58\u6216\u7F16\u8F91 .md \u6587\u4EF6\u65F6\uFF0C\u5C06\u81EA\u52A8\u89E6\u53D1\u5904\u7406");
    }
    containerEl.createEl("hr");
    new import_obsidian.Setting(containerEl).setName("\u9A8C\u8BC1\u6A21\u578B\u914D\u7F6E").setDesc("\u6D4B\u8BD5\u5F53\u524D\u6A21\u578B\u7684 API \u662F\u5426\u53EF\u7528").addButton((button) => button.setButtonText("\u9A8C\u8BC1").setCta().onClick(async () => {
      const core = this.plugin.getCore();
      if (!core) {
        new import_obsidian.Notice("\u6838\u5FC3\u672A\u521D\u59CB\u5316");
        return;
      }
      const result = await core.validateCurrentModel();
      new import_obsidian.Notice(result.valid ? "API \u9A8C\u8BC1\u901A\u8FC7" : `\u9A8C\u8BC1\u5931\u8D25: ${result.error}`);
    }));
  }
};
